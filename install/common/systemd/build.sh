...
reassign_values (){
  ...
  if [[ "${EXEC_FILE}" == *".js" ]]; then
	SERVICE_TYPE="simple"
	SYSTEMD_ENVIRONMENT="HOST=${APP_URLS#*://} HOSTNAME=${APP_URLS#*://} APP_HOST=${APP_URLS#*://}"
	...
	SYSTEMD_ENVIRONMENT="SPRING_APPLICATION_NAME=${SPRING_APPLICATION_NAME} SERVER_PORT=${SERVICE_PORT} LOG_FILE_PATH=${LOG_DIR}/${SERVICE_NAME}.log SERVER_ADDRESS=${APP_URLS#*://} JAVA_TOOL_OPTIONS=-Dmanagement.server.address=${APP_URLS#*://}"
	SERVICE_TYPE="notify"
