...
copy buildtools\install\win\WinSW3.0.0.exe "buildtools\install\win\Files\tools\AI.Chat.exe" /y
copy buildtools\install\win\tools\AI.Chat.xml "buildtools\install\win\Files\tools\AI.Chat.xml" /y
