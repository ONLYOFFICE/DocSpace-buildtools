...
mkdir -p "%{buildroot}%{_sysconfdir}/%{package_sysname}/%{product}/.private/"
mkdir -p "%{buildroot}%{_sysconfdir}/%{package_sysname}/%{product}/openresty"
...
mkdir -p "%{buildroot}%{_var}/log/%{package_sysname}/%{product}/"
mkdir -p "%{buildroot}%{_var}/www/%{package_sysname}/Data/Studio/webplugins/"
...
mkdir -p "%{buildroot}%{buildpath}/services/ASC.Data.Backup.Worker/"
...
mkdir -p "%{buildroot}%{buildpath}/services/ASC.AI.Chat/"
...
rsync -a --exclude='nginx' %{_builddir}/buildtools/config/ "%{buildroot}%{_sysconfdir}/%{package_sysname}/%{product}/"
...
rsync -a %{_builddir}/buildtools/install/docker/config/fluent-bit.conf "%{buildroot}%{_sysconfdir}/%{package_sysname}/%{product}/"
rsync -a %{_builddir}/buildtools/install/docker/config/nginx/proxy/letsencrypt.conf "%{buildroot}%{_sysconfdir}/openresty/includes/"
rsync -a %{_builddir}/buildtools/install/docker/config/nginx/proxy/onlyoffice* "%{buildroot}%{_sysconfdir}/openresty/conf.d/"
rsync -a %{_builddir}/buildtools/install/docker/config/nginx/nginx.conf.template "%{buildroot}%{_sysconfdir}/%{package_sysname}/%{product}/openresty/"
rsync -a %{_builddir}/campaigns/src/campaigns/ "%{buildroot}%{buildpath}/public/campaigns/"
rsync -a %{_builddir}/plugins/publish/ "%{buildroot}%{_var}/www/%{package_sysname}/Data/Studio/webplugins/"
rsync -a %{_builddir}/publish/services/ASC.AI.Worker/service/ "%{buildroot}%{buildpath}/products/ASC.AI/service/"
...
rsync -a %{_builddir}/publish/services/ASC.Data.Backup.Worker/service/ "%{buildroot}%{buildpath}/services/ASC.Data.Backup.Worker/"
rsync -a %{_builddir}/publish/services/ASC.Data.Backup/service/ "%{buildroot}%{buildpath}/services/ASC.Data.Backup/"
rsync -a %{_builddir}/publish/services/ASC.Files.Worker/service/ "%{buildroot}%{buildpath}/products/ASC.Files/service/"
...
rsync -a %{_builddir}/publish/services/ASC.AI.Chat/ "%{buildroot}%{buildpath}/services/ASC.AI.Chat/"
