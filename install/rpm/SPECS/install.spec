...
mkdir -p "%{buildroot}%{buildpath}/services/qdrant/"
...
mkdir -p "%{buildroot}%{buildpath}/products/ASC.Sdk/sdk/.next/"
...
cp -rf %{_builddir}/publish/web/sdk/.next/* "%{buildroot}%{buildpath}/products/ASC.Sdk/sdk/.next/"
...
cp -rf %{_builddir}/buildtools/install/docker/config/nginx/onlyoffice-proxy-ssl.conf.template "%{buildroot}%{_sysconfdir}/openresty/conf.d/onlyoffice-proxy-ssl.conf.template"
...
cp -rf %{_builddir}/langflow/.local "%{buildroot}%{buildpath}/services/langflow/"
cp -rf %{_builddir}/langflow/dist/*.whl "%{buildroot}%{buildpath}/services/langflow/"
cp -rf %{_builddir}/langflow/src/frontend/build/* "%{buildroot}%{_sysconfdir}/openresty/html/langflow/"
cp -rf %{_builddir}/langflow/src/frontend/onlyoffice-langflow.conf "%{buildroot}%{_sysconfdir}/openresty/includes/"
cp -rf %{_builddir}/langflow/qdrant "%{buildroot}%{buildpath}/services/"
