...
mkdir -p "%{buildroot}%{buildpath}/services/langflow/.venv"
mkdir -p "%{buildroot}%{buildpath}/services/langflow/src"
...
cp -rf %{_builddir}/langflow/uv.lock "%{buildroot}%{buildpath}/services/langflow/"
cp -rf %{_builddir}/langflow/README.md "%{buildroot}%{buildpath}/services/langflow/"
cp -rf %{_builddir}/langflow/pyproject.toml "%{buildroot}%{buildpath}/services/langflow/"
cp -rf %{_builddir}/langflow/src/backend "%{buildroot}%{buildpath}/services/langflow/src/"
