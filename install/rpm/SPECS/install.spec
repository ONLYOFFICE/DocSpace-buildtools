...
mkdir -p "%{buildroot}%{buildpath}/products/ASC.Management/management/.next/"
...
cp -rf %{_builddir}/publish/web/management/.next/* "%{buildroot}%{buildpath}/products/ASC.Management/management/.next/"
