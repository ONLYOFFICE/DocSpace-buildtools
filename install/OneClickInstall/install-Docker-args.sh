...
while [ "$1" != "" ]; do
    case "$1" in
        ...
        -http    | --httpport | -ep | --externalport ) [ -n "$2" ] && HTTP_PORT=$2                                                && shift ;;
        -https   | --httpsport           ) [ -n "$2" ] && HTTPS_PORT=$2                                                           && shift ;;
        ...
        -h | -? | --help )
            ...
            echo "  --httpport          <port>              Public HTTP port for ${PRODUCT_NAME} (default: 80)"
            echo "  --httpsport         <port>              Public HTTPS port for ${PRODUCT_NAME} (default: 443)"
