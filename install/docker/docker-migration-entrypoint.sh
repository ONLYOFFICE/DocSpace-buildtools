...
CONECTION_TIMEOUT=${CONNECTION_TIMEOUT:-"300"}
PARAMETERS="standalone=true"

sed -i "s!\"ConnectionString\".*!\"ConnectionString\": \"Server=${MYSQL_HOST};Database=${MYSQL_DATABASE};User ID=${MYSQL_USER};Password=${MYSQL_PASSWORD};Connection Timeout=${CONECTION_TIMEOUT}\",!g" ./appsettings.runner.json
